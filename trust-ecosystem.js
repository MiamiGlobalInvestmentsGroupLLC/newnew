...
function techIcon(name){
  if(name==='Python') return `<svg class="tech-logo" viewBox="0 0 64 64" aria-label="Python logo"><path d="M32 8h-9c-6 0-10 4-10 10v8h19c6 0 10 4 10 10v2c0 6-4 10-10 10h-9c-6 0-10-4-10-10" fill="none" stroke="#3776AB" stroke-width="5" stroke-linecap="round"/><circle cx="26" cy="16" r="2.5" fill="#3776AB"/><path d="M32 56h9c6 0 10-4 10-10v-8H32c-6 0-10-4-10-10v-2c0-6 4-10 10-10h9c6 0 10 4 10 10" fill="none" stroke="#FFD343" stroke-width="5" stroke-linecap="round"/><circle cx="38" cy="48" r="2.5" fill="#C29C1D"/></svg>`;
  if(name==='Project Jupyter') return `<svg class="tech-logo" viewBox="0 0 64 64" aria-label="Project Jupyter logo"><circle cx="32" cy="32" r="14" fill="none" stroke="#EA7A24" stroke-width="5"/><ellipse cx="32" cy="32" rx="26" ry="8" fill="none" stroke="#C7C7C7" stroke-width="2.5"/><circle cx="15" cy="22" r="2.3" fill="#9CA3AF"/><circle cx="49" cy="42" r="2.3" fill="#9CA3AF"/></svg>`;
  if(name==='TensorFlow') return `<svg class="tech-logo" viewBox="0 0 64 64" aria-label="TensorFlow logo"><path d="M8 10h36v10H31v34H21V20H8z" fill="#FF6F00"/><path d="M28 20h28v10H43v24H33V30H28z" fill="#FFA000"/></svg>`;
  if(name==='PyTorch') return `<svg class="tech-logo" viewBox="0 0 64 64" aria-label="PyTorch logo"><path d="M32 8v14l10 10" stroke="#EE4C2C" stroke-width="5" fill="none" stroke-linecap="round"/><circle cx="32" cy="36" r="17" fill="none" stroke="#EE4C2C" stroke-width="5"/></svg>`;
  if(name==='Docker') return `<svg class="tech-logo" viewBox="0 0 64 64" aria-label="Docker logo"><rect x="10" y="29" width="8" height="8" fill="#2496ED"/><rect x="20" y="29" width="8" height="8" fill="#2496ED"/><rect x="30" y="29" width="8" height="8" fill="#2496ED"/><rect x="20" y="19" width="8" height="8" fill="#2496ED"/><path d="M10 40h23c7 0 13-3 16-9 1.6 0 3.2-.5 4.8-1.5-1.2-1.5-3-2.2-5.2-2.2-.7-2.7-2.4-4.8-5.1-6.2.5 2.6 0 4.6-1.7 6.1-1.8 1.6-4 2.3-6.5 2.3H10z" fill="#2496ED"/></svg>`;
  if(name==='Kubernetes') return `<svg class="tech-logo" viewBox="0 0 64 64" aria-label="Kubernetes logo"><polygon points="32,6 50,16 50,36 32,46 14,36 14,16" fill="#326CE5"/><circle cx="32" cy="26" r="7" fill="#fff"/><path d="M32 18v16M25 22l14 8M25 30l14-8" stroke="#326CE5" stroke-width="2"/></svg>`;
  return `<svg class="tech-logo" viewBox="0 0 64 64" aria-label="Git logo"><rect x="14" y="14" width="36" height="36" rx="6" transform="rotate(45 32 32)" fill="#F05133"/><path d="M24 32h16M32 24v16" stroke="#fff" stroke-width="3" stroke-linecap="round"/><circle cx="24" cy="32" r="2.6" fill="#fff"/><circle cx="32" cy="24" r="2.6" fill="#fff"/><circle cx="32" cy="40" r="2.6" fill="#fff"/></svg>`;
}

function markSVG(i){
  const accent = ['#b99645','#2f3a46','#8a6a26','#1f2f44','#a58131'][i % 5];
  return `<svg class="mark-icon" viewBox="0 0 64 64" aria-label="MGI trust mark"><circle cx="32" cy="32" r="28" fill="none" stroke="${accent}" stroke-width="2.8"/><path d="M20 42V22l12 10 12-10v20" fill="none" stroke="${accent}" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M18 46h28" stroke="${accent}" stroke-width="2.4"/><text x="32" y="56" text-anchor="middle" font-size="8" letter-spacing="1" fill="${accent}" font-family="Georgia">MGI</text></svg>`;
}
